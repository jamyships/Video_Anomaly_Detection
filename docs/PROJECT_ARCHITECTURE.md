...
This document is the project’s **source of truth** for the intended architecture and
is mirrored from the root `PROJECT_ARCHITECTURE.md` so the code + docs stay aligned.
...
and modern** VAD pipeline described in the accompanying write-up. It combines:
